...
namespace UnityEditor.UI
{
    ...
    static public class ExpandedMenuOptions
    {
        ...
        static private ExpandedControls.Resources s_StandardResources;

        static public ExpandedControls.Resources GetStandardResources()
        {
        ...
        public static void PlaceUIElementRoot(GameObject element, MenuCommand menuCommand)
        {
            ...
            if (parent.GetComponentsInParent<Canvas>(true).Length == 0)
            {
                ...
                GameObject canvas = ExpandedMenuOptions.CreateNewUI();
        ...
        static public GameObject GetOrCreateCanvasGameObject()
        {
            ...
            return ExpandedMenuOptions.CreateNewUI();
        }
