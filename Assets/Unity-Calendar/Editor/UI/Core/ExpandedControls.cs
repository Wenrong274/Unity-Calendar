...
namespace UnityEngine.UI
{
    ...
    /// </remarks>
    public static class ExpandedControls
    {
        ...
        /// <param name="resources">The resources to use for creation.</param>
        /// <returns>The root GameObject of the created element.</returns>
        public static GameObject CreateExpandedDropdown(Resources resources)
        {
            GameObject root = CreateUIElementRoot("ExpandedDropdown", s_ThickElementSize, typeof(Image), typeof(ExpandedDropdown));
